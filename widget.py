...
def set_column_utils(app):
    ...
    app.adversaire_taux_historique_label = tkinter.Label(app.column_frame, text= "Taux Historique\nB (à l'extérieur)", font='Helvetica 16 bold',fg='black', bg='white', borderwidth=2,height = 5, width = app.small_column)
    app.adversaire_taux_saison_label = tkinter.Label(app.column_frame, text= "Taux Saison B\n(à l'extérieur)", font='Helvetica 16 bold', fg='black', bg='white', borderwidth=2, height = 5, width = app.small_column)
