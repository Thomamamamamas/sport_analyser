...
def set_column_utils(app):
    ...
    app.taux_historique_label = tkinter.Label(app.column_frame, text= "Taux Historique (A)\n(à domicile)", font='Helvetica 16 bold',fg='black', bg='white', borderwidth=2, height = 5, width = app.small_column)
    app.taux_saison_label = tkinter.Label(app.column_frame, text= "Taux Saison (A)\n(à domicile)", font='Helvetica 16 bold', fg='black', bg='white', borderwidth=2, height = 5, width = app.small_column)
    ...
    app.tete_a_tete_label = tkinter.Label(app.column_frame, text="Tête-à-tête\n(matchs)", font='Helvetica 16 bold', fg='black', bg='white', borderwidth=2,  height = 5, width = app.large_column)
    ...
    app.taux_a_contre_b_label = tkinter.Label(app.column_frame, text="Taux A contre B\n(à domicile)", font='Helvetica 16 bold', fg='black', bg='white', borderwidth=2,  height = 5, width = app.small_column)
    ...
    app.moyenne_match_label = tkinter.Label(app.column_frame, text="Moyenne buts par Match", font='Helvetica 16 bold', fg='black', bg='white', borderwidth=2,  height = 5, width = app.large_column)
    app.moyenne_but_marque_label = tkinter.Label(app.column_frame, text="Moyenne buts marqués", font='Helvetica 16 bold', fg='black', bg='white', borderwidth=2,  height = 5, width = app.large_column)
